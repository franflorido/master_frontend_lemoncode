...
import { DogScene, CatScene } from "@/scenes";
...
export const AppRouter:React.FC<Props> = (props) => {
  ...
  return (
    <HashRouter>
      <Routes>
        <Route path={switchRoutes.root} element={<CatScene selectedImages={selectedImages} toggleImageSelection={toggleImageSelection} deleteImagesfromCarrito={deleteImagesfromCarrito} />}></Route>
